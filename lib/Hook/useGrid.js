export default function useGrid(crosswordClues) {
  const grid = [
    ...
    [
      ...
      { id: 3, letter: `${crosswordClues[2].isCorrectlyAnswered ? "E" : ""}` },
      {
        id: 3,
        letter: `${
          crosswordClues[2].isCorrectlyAnswered ||
      ...
      -1,
      { id: 7, letter: `${crosswordClues[6].isCorrectlyAnswered ? "D" : ""}` },
    ],
    [
      -1,
      { id: 4, letter: `${crosswordClues[3].isCorrectlyAnswered ? "U" : ""}` },
      -1,
      { id: 5, letter: `${crosswordClues[4].isCorrectlyAnswered ? "E" : ""}` },
      -1,
      { id: 6, letter: `${crosswordClues[5].isCorrectlyAnswered ? "O" : ""}` },
      -1,
      { id: 7, letter: `${crosswordClues[6].isCorrectlyAnswered ? "O" : ""}` },
    ],
    [
      {
        id: 8,
      ...
      { id: 8, letter: `${crosswordClues[7].isCorrectlyAnswered ? "R" : ""}` },
      {
        id: 5,
        letter: `${
          crosswordClues[4].isCorrectlyAnswered ||
      ...
      { id: 8, letter: `${crosswordClues[7].isCorrectlyAnswered ? "U" : ""}` },
      {
        id: 6,
        letter: `${
          crosswordClues[5].isCorrectlyAnswered ||
      ...
      { id: 8, letter: `${crosswordClues[7].isCorrectlyAnswered ? "E" : ""}` },
      {
        id: 7,
        letter: `${
    ...
    [
      -1,
      { id: 4, letter: `${crosswordClues[3].isCorrectlyAnswered ? "O" : ""}` },
      -1,
      -1,
      -1,
      { id: 6, letter: `${crosswordClues[5].isCorrectlyAnswered ? "T" : ""}` },
      -1,
      -1,
    ],
    [
      ...
      { id: 9, letter: `${crosswordClues[8].isCorrectlyAnswered ? "E" : ""}` },
      { id: 9, letter: `${crosswordClues[8].isCorrectlyAnswered ? "H" : ""}` },
      -1,
      -1,
      -1,
      -1,
